...
<div class="item">
    <div class="product">
        ...
        <div class="text pt-3 px-3">
            <h3 class="text-gray-800 font-semibold text-xl">{{ $product->name }}</h3>
            <p class="text-gray-500 text-xs">{{ number_format($product->qty, 0) }} in Stock</p>
            <div class="d-flex">
		    	<div class="pricing">
                    <p class="price"><span> {{ session()->get('default_currency')->symbol . number_format($product->price, 2) }}</span></p>
                </div>
            </div>
            <!-- <div class="ml-auto">
